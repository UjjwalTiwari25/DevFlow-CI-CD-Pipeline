...
router.delete('/repositories/:id', wrap(async (req, res) => {
...
router.post('/pipelines/:id/rerun', wrap(async (req, res) => {
...
router.post('/deployments/trigger/:repoId', wrap(async (req, res) => {
  res.status(201).json({ status: 'success', data: await ds.triggerDeployment(req.params.repoId) });
}));
router.post('/deployments/:id/rollback', wrap(async (req, res) => {
