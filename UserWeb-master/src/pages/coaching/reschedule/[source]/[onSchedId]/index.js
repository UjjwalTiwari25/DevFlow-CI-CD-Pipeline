...
import ReschedulePage from '../../../../../components/page/reschedule/[source]/[onSchedId]';
import BaseLayout from '../../../../../layouts/BaseLayout';
import { getAppointmentWithOnSchedId } from '../../../../../models/service';
import { wrapper } from '../../../../../store';

export default function Reschedule({ appointmentDetails }) {
  ...
  return (
    <BaseLayout useAuth>
      <Head>
        <title>Reschedule Appointment - Aura</title>
        {/* TODO: We will need to improve these meta tags */}
        <meta property="og:title" content={`Reschedule Appointment - Aura`} />
      ...
      {appointmentDetails && (
        <ReschedulePage appointmentDetails={appointmentDetails} />
      )}
    </BaseLayout>
  );
}
